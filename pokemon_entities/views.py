...
def show_pokemon(request, pokemon_id):
    ...
    # if requested_pokemon.next_evolutions.all(): context.update({
    # 'pokemon_next_evolutions': requested_pokemon.next_evolutions.all(),
    # 'pokemon_next_evolutions_id': requested_pokemon.next_evolutions.all()[
    # 0].id, 'pokemon_next_evolutions_img_url':
